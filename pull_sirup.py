# -*- coding: utf-8 -*-
"""
Pull all data from SIRUP Inaproc DataTables API (2026 budget year).
...
Usage: uv run --with httpx pull_sirup.py
"""
...
OUTPUT_FILE = "sirup_2026_all.jsonl"
CHECKPOINT_FILE = "sirup_checkpoint.json"
...
COOKIES = {
    "PLAY_SESSION": "596baed944a2fbb195afe4ace1a0fbbbc3cfc38f-___TS=1784118415462&tahunAnggaranPilihan=2026&menu=cariPaket2&___ID=6ab5d171-a57e-46ef-8333-6fa4e48507b5",
...
def main():
    ...
    try:
        print(f"[INFO] Fetching initial page to get total count...")
